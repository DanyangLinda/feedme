...
CREATE TABLE IF NOT EXISTS `foodie`.`order` (
  `id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `foodie`.`login_log`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `foodie`.`login_log` ;

CREATE TABLE IF NOT EXISTS `foodie`.`login_log` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `userId` INT NOT NULL,
  `time` DATETIME NULL,
  PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
-- Table `foodie`.`user_prefer`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `foodie`.`user_prefer` ;

CREATE TABLE IF NOT EXISTS `foodie`.`user_prefer` (
  `id` INT NOT NULL,
  ...
  `user_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_user_prefer_user1_idx` (`user_id` ASC),
...
-- -----------------------------------------------------
-- Table `foodie`.`orderDishes`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `foodie`.`orderDishes` ;

CREATE TABLE IF NOT EXISTS `foodie`.`orderDishes` (
  `orderId` INT NOT NULL,
  `dishId` INT NOT NULL,
  `amount` INT NULL,
  `price` INT NULL,
