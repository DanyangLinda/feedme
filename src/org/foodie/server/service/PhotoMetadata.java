...
public class PhotoMetadata implements Serializable {
    ...
    private static final Logger LOG = Logger.getLogger(PhotoMetadata.class);
    ...
    public PhotoMetadata(String fileName, Date documentDate, String personName) {
        this(UUID.randomUUID().toString(), fileName, documentDate,personName);
    }
    
    public PhotoMetadata(String uuid, String fileName, Date documentDate, String personName) {
        super();
        this.uuid = uuid;
    ...
    public PhotoMetadata(Properties properties) {
